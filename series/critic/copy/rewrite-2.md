# Rewrite the copy of the shorts still rated 5 (second pass)

Rewrite these 5 entries in series/copy-draft.json: 6, 14, 23, 28, 61. Change nothing else
in the repo.
...
- A blind rater's notes on the current versions: series/critic/copy/ratings-after.json
  ("weakest" is the main complaint). Fix what it names.
- How each short is timed on screen, as the rater saw it: series/critic/copy/brief-after.md.
  A line has only the seconds shown there to be read.
