...
test("reads every character in series/characters.json", async () => {
  ...
  const known = /^--(order|walls|spill|stand|grow|moon|phases|drop|drop-step|rain|lie-step|lift|lean|turn|shed|last-water|last|stagger|wall-step|wall-height|glass-walls|pool|camera|zoom|edge|water)$/;
